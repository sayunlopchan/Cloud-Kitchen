...
const Detail_Skeleton = () => {
  return (
    <div className='p-2 lg:p-10 space-y-5 '>
      ...
      {/* main */}
      <section className='w-full h-2/3 max-sm:flex-col md:flex '>
        {/* img */}
        <div className='w-full md:w-2/5 lg:h-[400px] flex justify-center items-center'>
        ...
        {/* details */}
        <div className='md:w-3/5 h-full p-5 space-y-2'>
